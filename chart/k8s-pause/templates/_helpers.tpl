...
*/}}
{{- define "k8s-pause.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "k8s-pause.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
